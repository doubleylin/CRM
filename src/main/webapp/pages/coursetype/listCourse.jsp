...
<s:form namespace="/" action="findCourseTypeByPage">
...
<table width="97%" border="1">
	...
	<s:iterator value="#session.pageBean.data" var="c">
		<tr class="tabtd1">
			<td align="center">${c.courseName}</td>
			<td align="center">${c.remark}</td>
			<td align="center">${c.total}</td>
			<td align="center">${c.courseCost}</td>
			<td width="11%" align="center">

				<a href="${pageContext.request.contextPath}
				/pages/coursetype/addOrEditCourse.jsp?
				courseTypeId=${c.courseTypeId}&
				courseCost=${c.courseCost}&
				total=${c.total}&remark=${c.remark}&
				courseName=${c.courseName}"><img
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td align="right">
			...
			<span>
        	<a href="findCourseTypeByPage">[首页]</a>&nbsp;&nbsp;
            <a href="findCourseTypeByPage?pageNum=${pageBean.pageNum-1}">[上一页]</a>&nbsp;&nbsp;
                <s:iterator begin="#pageBean.start" end="#pageBean.end" var="num">
					<s:if test="#num <= #pageBean.totalPage">
                            <a href="findCourseTypeByPage?pageNum=${num}">
            ...
            <a
					<c:choose>
						...
						<c:otherwise>href="findCourseTypeByPage?pageNum=${pageBean.pageNum + 1}"</c:otherwise>

					</c:choose>
			>[下一页]</a>&nbsp;&nbsp;
            <a href="findCourseTypeByPage?pageNum=${pageBean.totalPage}">[尾页]</a>
        </span>
		</td>
	</tr>
</table>
